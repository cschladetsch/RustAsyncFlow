...
Run with: python demo.py or python3 demo.py
"""
...
try:
    ...
    print("❌ Error importing AsyncFlow components")
    print(f"Error: {e}")
...
async def main():
    ...
    print()
    print("This demo works on:")
    print("  • Windows (any Python 3.7+)")
    print("  • macOS (any Python 3.7+)")
    print("  • Linux (any Python 3.7+)")
